...
<head>
    <meta charset="UTF-8">
    <title>Student Profile - SECMS</title>
    <style>
...
<div class="sidebar">
    ...
    <a href="student_profile.php" class="active">My Profile Sheet</a>
...
<div class="workspace">
    <header class="top-header">
        <div style="font-size: 15px; font-weight: 500; color: var(--text-light);">Workspace Context: <strong>Student Terminal</strong></div>
